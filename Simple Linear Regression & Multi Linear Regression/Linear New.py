...
wcat=pd.read_csv("E:\\Classes\\Trainer Tools\\Final\\03 Linear Regression\\Data Sets\\wc-at.csv")
...
pred3
pred3.corr(wcat.AT)
plt.scatter(x=wcat['Waist'],y=wcat['AT'],color='green');plt.plot(wcat.Waist,pred3,color='blue');plt.xlabel('WAIST');plt.ylabel('TISSUE')
